...
The category with the highest average rating in the Google Play Store and Apple App Store respectively are "Books_And_Reference" with `r highest_rating_goog` and "Productivity" with "4.00". This tell us that more consumers are satisfied with these categories compared to others.
